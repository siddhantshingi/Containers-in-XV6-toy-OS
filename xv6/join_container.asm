...
_join_container:     file format elf32-i386
...
int main ( int argc , char * argv [])
{
  ...
  1f:	e8 76 03 00 00       	call   39a <join_container>
  ps();
  24:	e8 21 03 00 00       	call   34a <ps>
  printf(1,"done\n");
  29:	58                   	pop    %eax
  2a:	5a                   	pop    %edx
  2b:	68 b8 07 00 00       	push   $0x7b8
  30:	6a 01                	push   $0x1
  32:	e8 29 04 00 00       	call   460 <printf>
  exit();
...
00000372 <sleepcustom>:
SYSCALL(sleepcustom)
 372:	b8 1e 00 00 00       	mov    $0x1e,%eax
 377:	cd 40                	int    $0x40
 379:	c3                   	ret    

0000037a <wakeupcustom>:
...
0000038a <create_container>:
SYSCALL(create_container)
 38a:	b8 21 00 00 00       	mov    $0x21,%eax
 38f:	cd 40                	int    $0x40
 391:	c3                   	ret    

00000392 <destroy_container>:
SYSCALL(destroy_container)
 392:	b8 22 00 00 00       	mov    $0x22,%eax
 397:	cd 40                	int    $0x40
 399:	c3                   	ret    

0000039a <join_container>:
SYSCALL(join_container)
 39a:	b8 23 00 00 00       	mov    $0x23,%eax
 39f:	cd 40                	int    $0x40
 3a1:	c3                   	ret    

000003a2 <leave_container>:
SYSCALL(leave_container)
 3a2:	b8 24 00 00 00       	mov    $0x24,%eax
 3a7:	cd 40                	int    $0x40
 3a9:	c3                   	ret    

000003aa <container_malloc>:
 3aa:	b8 25 00 00 00       	mov    $0x25,%eax
 3af:	cd 40                	int    $0x40
 3b1:	c3                   	ret    
 ...
 3c9:	85 d2                	test   %edx,%edx
{
 ...
 3f7:	f7 f1                	div    %ecx
 3f9:	0f b6 92 c8 07 00 00 	movzbl 0x7c8(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, const char *fmt, ...)
{
 ...
 4a0:	e8 0d fe ff ff       	call   2b2 <write>
 ...
 501:	e8 ac fd ff ff       	call   2b2 <write>
 ...
 518:	31 ff                	xor    %edi,%edi
  write(fd, &c, 1);
 51a:	e8 93 fd ff ff       	call   2b2 <write>
  for(i = 0; fmt[i]; i++){
 ...
 5b3:	57                   	push   %edi
 5b4:	53                   	push   %ebx
 5b5:	e8 f8 fc ff ff       	call   2b2 <write>
        while(*s != 0){
 ...
 607:	e8 a6 fc ff ff       	call   2b2 <write>
        ap++;
 ...
 614:	e9 8f fe ff ff       	jmp    4a8 <printf+0x48>
          s = "(null)";
 619:	bb be 07 00 00       	mov    $0x7be,%ebx
        while(*s != 0){
 ...
 631:	a1 6c 0a 00 00       	mov    0xa6c,%eax
{
 ...
 66d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 66f:	a3 6c 0a 00 00       	mov    %eax,0xa6c
}
 674:	5b                   	pop    %ebx
 675:	5e                   	pop    %esi
 676:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 6c9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6cc:	8b 15 6c 0a 00 00    	mov    0xa6c,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 736:	e8 f5 fe ff ff       	call   630 <free>
  return freep;
 73b:	8b 15 6c 0a 00 00    	mov    0xa6c,%edx
 ...
 779:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 780:	c7 05 6c 0a 00 00 70 	movl   $0xa70,0xa6c
 787:	0a 00 00 
 78a:	c7 05 70 0a 00 00 70 	movl   $0xa70,0xa70
 791:	0a 00 00 
    base.s.size = 0;
 794:	b8 70 0a 00 00       	mov    $0xa70,%eax
 799:	c7 05 74 0a 00 00 00 	movl   $0x0,0xa74
 7a0:	00 00 00 
