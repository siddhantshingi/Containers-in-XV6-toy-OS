...
extern int counter[24];
extern char syscall_arr[24][20];
extern int trace;
...
extern int sys_store(void);
extern int sys_sleepcustom(void);
extern int sys_wakeupcustom(void);
extern int sys_read_mean(void);
...
[SYS_store]   sys_store,
[SYS_sleepcustom]    sys_sleepcustom,
[SYS_wakeupcustom]    sys_wakeupcustom,
[SYS_read_mean]	  sys_read_mean,
