...
00000482 <sleepcustom>:
SYSCALL(sleepcustom)
 482:	b8 1e 00 00 00       	mov    $0x1e,%eax
 487:	cd 40                	int    $0x40
 489:	c3                   	ret    

0000048a <wakeupcustom>:
...
0000049a <create_container>:
SYSCALL(create_container)
 49a:	b8 21 00 00 00       	mov    $0x21,%eax
 49f:	cd 40                	int    $0x40
 4a1:	c3                   	ret    

000004a2 <destroy_container>:
SYSCALL(destroy_container)
 4a2:	b8 22 00 00 00       	mov    $0x22,%eax
 4a7:	cd 40                	int    $0x40
 4a9:	c3                   	ret    

000004aa <join_container>:
SYSCALL(join_container)
 4aa:	b8 23 00 00 00       	mov    $0x23,%eax
 4af:	cd 40                	int    $0x40
 4b1:	c3                   	ret    

000004b2 <leave_container>:
SYSCALL(leave_container)
 4b2:	b8 24 00 00 00       	mov    $0x24,%eax
 4b7:	cd 40                	int    $0x40
 4b9:	c3                   	ret    

000004ba <container_malloc>:
 4ba:	b8 25 00 00 00       	mov    $0x25,%eax
 4bf:	cd 40                	int    $0x40
 4c1:	c3                   	ret    
