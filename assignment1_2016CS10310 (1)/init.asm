...
00000422 <sleepcustom>:
SYSCALL(sleepcustom)
 422:	b8 1e 00 00 00       	mov    $0x1e,%eax
 427:	cd 40                	int    $0x40
 429:	c3                   	ret    

0000042a <wakeupcustom>:
