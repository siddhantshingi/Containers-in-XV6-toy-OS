...
000003a2 <sleepcustom>:
SYSCALL(sleepcustom)
 3a2:	b8 1e 00 00 00       	mov    $0x1e,%eax
 3a7:	cd 40                	int    $0x40
 3a9:	c3                   	ret    

000003aa <wakeupcustom>:
