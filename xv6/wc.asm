...
000004b2 <sleepcustom>:
SYSCALL(sleepcustom)
 4b2:	b8 1e 00 00 00       	mov    $0x1e,%eax
 4b7:	cd 40                	int    $0x40
 4b9:	c3                   	ret    

000004ba <wakeupcustom>:
