...
00000442 <sleepcustom>:
SYSCALL(sleepcustom)
 442:	b8 1e 00 00 00       	mov    $0x1e,%eax
 447:	cd 40                	int    $0x40
 449:	c3                   	ret    

0000044a <wakeupcustom>:
