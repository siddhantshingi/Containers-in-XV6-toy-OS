...
_container_malloc:     file format elf32-i386
...
int main ( int argc , char * argv [])
{
  ...
  11:	6a 01                	push   $0x1
  13:	e8 82 03 00 00       	call   39a <container_malloc>
  ...
  exit();
  27:	83 c4 20             	add    $0x20,%esp
  2a:	e8 53 02 00 00       	call   282 <exit>
  2f:	90                   	nop
...
00000362 <sleepcustom>:
SYSCALL(sleepcustom)
 362:	b8 1e 00 00 00       	mov    $0x1e,%eax
 367:	cd 40                	int    $0x40
 369:	c3                   	ret    

0000036a <wakeupcustom>:
...
0000037a <create_container>:
SYSCALL(create_container)
 37a:	b8 21 00 00 00       	mov    $0x21,%eax
 37f:	cd 40                	int    $0x40
 381:	c3                   	ret    

00000382 <destroy_container>:
SYSCALL(destroy_container)
 382:	b8 22 00 00 00       	mov    $0x22,%eax
 387:	cd 40                	int    $0x40
 389:	c3                   	ret    

0000038a <join_container>:
SYSCALL(join_container)
 38a:	b8 23 00 00 00       	mov    $0x23,%eax
 38f:	cd 40                	int    $0x40
 391:	c3                   	ret    

00000392 <leave_container>:
SYSCALL(leave_container)
 392:	b8 24 00 00 00       	mov    $0x24,%eax
 397:	cd 40                	int    $0x40
 399:	c3                   	ret    

0000039a <container_malloc>:
 39a:	b8 25 00 00 00       	mov    $0x25,%eax
 39f:	cd 40                	int    $0x40
 3a1:	c3                   	ret    
 ...
 3b9:	85 d2                	test   %edx,%edx
{
 ...
 3e7:	f7 f1                	div    %ecx
 3e9:	0f b6 92 d0 07 00 00 	movzbl 0x7d0(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, const char *fmt, ...)
{
 ...
 490:	e8 0d fe ff ff       	call   2a2 <write>
 ...
 4f1:	e8 ac fd ff ff       	call   2a2 <write>
 ...
 508:	31 ff                	xor    %edi,%edi
  write(fd, &c, 1);
 50a:	e8 93 fd ff ff       	call   2a2 <write>
  for(i = 0; fmt[i]; i++){
 ...
 5a3:	57                   	push   %edi
 5a4:	53                   	push   %ebx
 5a5:	e8 f8 fc ff ff       	call   2a2 <write>
        while(*s != 0){
 ...
 5f7:	e8 a6 fc ff ff       	call   2a2 <write>
        ap++;
 ...
 604:	e9 8f fe ff ff       	jmp    498 <printf+0x48>
          s = "(null)";
 609:	bb c6 07 00 00       	mov    $0x7c6,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 621:	a1 74 0a 00 00       	mov    0xa74,%eax
{
 ...
 65d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 65f:	a3 74 0a 00 00       	mov    %eax,0xa74
}
 664:	5b                   	pop    %ebx
 665:	5e                   	pop    %esi
 666:	5f                   	pop    %edi
 ...
 676:	72 ce                	jb     646 <free+0x26>
{
 ...
 697:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 69a:	a3 74 0a 00 00       	mov    %eax,0xa74
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6b9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6bc:	8b 15 74 0a 00 00    	mov    0xa74,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 726:	e8 f5 fe ff ff       	call   620 <free>
  return freep;
 72b:	8b 15 74 0a 00 00    	mov    0xa74,%edx
 ...
 777:	0a 00 00 
 77a:	c7 05 78 0a 00 00 78 	movl   $0xa78,0xa78
 781:	0a 00 00 
    base.s.size = 0;
 784:	b8 78 0a 00 00       	mov    $0xa78,%eax
 789:	c7 05 7c 0a 00 00 00 	movl   $0x0,0xa7c
 790:	00 00 00 
