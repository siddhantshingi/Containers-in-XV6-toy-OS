...
_destroy_container:     file format elf32-i386
 ...
 621:	a1 54 0a 00 00       	mov    0xa54,%eax
{
 ...
 65d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 65f:	a3 54 0a 00 00       	mov    %eax,0xa54
}
 664:	5b                   	pop    %ebx
 665:	5e                   	pop    %esi
 666:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 6ff:	73 47                	jae    748 <malloc+0x98>
    ...
    if(p == freep)
 701:	39 05 54 0a 00 00    	cmp    %eax,0xa54
 ...
 726:	e8 f5 fe ff ff       	call   620 <free>
  return freep;
 72b:	8b 15 54 0a 00 00    	mov    0xa54,%edx
 ...
 754:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 757:	89 15 54 0a 00 00    	mov    %edx,0xa54
}
 ...
 769:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 770:	c7 05 54 0a 00 00 58 	movl   $0xa58,0xa54
 777:	0a 00 00 
 77a:	c7 05 58 0a 00 00 58 	movl   $0xa58,0xa58
 781:	0a 00 00 
    base.s.size = 0;
 784:	b8 58 0a 00 00       	mov    $0xa58,%eax
 789:	c7 05 5c 0a 00 00 00 	movl   $0x0,0xa5c
 790:	00 00 00 
