...
int main ( int argc , char * argv [])
{
  ...
  2b:	56                   	push   %esi
  2c:	50                   	push   %eax
  2d:	e8 18 03 00 00       	call   34a <add>
  exit();
...
0000037a <sleepcustom>:
SYSCALL(sleepcustom)
 37a:	b8 1f 00 00 00       	mov    $0x1f,%eax
 37f:	cd 40                	int    $0x40
 381:	c3                   	ret    

00000382 <wakeupcustom>:
