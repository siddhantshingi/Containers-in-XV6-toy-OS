...
_create_container:     file format elf32-i386
...
int main ( int argc , char * argv [])
{
  ...
  create_container();
  11:	e8 54 03 00 00       	call   36a <create_container>
  exit();
...
00000352 <sleepcustom>:
SYSCALL(sleepcustom)
 352:	b8 1e 00 00 00       	mov    $0x1e,%eax
 357:	cd 40                	int    $0x40
 359:	c3                   	ret    

0000035a <wakeupcustom>:
