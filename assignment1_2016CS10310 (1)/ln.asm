...
00000392 <sleepcustom>:
SYSCALL(sleepcustom)
 392:	b8 1e 00 00 00       	mov    $0x1e,%eax
 397:	cd 40                	int    $0x40
 399:	c3                   	ret    

0000039a <wakeupcustom>:
...
printf(int fd, const char *fmt, ...)
{
 ...
 4c0:	e8 0d fe ff ff       	call   2d2 <write>
 ...
 521:	e8 ac fd ff ff       	call   2d2 <write>
 ...
 538:	31 ff                	xor    %edi,%edi
  write(fd, &c, 1);
 53a:	e8 93 fd ff ff       	call   2d2 <write>
  for(i = 0; fmt[i]; i++){
 ...
 5d3:	57                   	push   %edi
 5d4:	53                   	push   %ebx
 5d5:	e8 f8 fc ff ff       	call   2d2 <write>
        while(*s != 0){
 ...
 627:	e8 a6 fc ff ff       	call   2d2 <write>
        ap++;
...
free(void *ap)
{
 ...
 651:	a1 b0 0a 00 00       	mov    0xab0,%eax
{
 ...
 68d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 68f:	a3 b0 0a 00 00       	mov    %eax,0xab0
}
 694:	5b                   	pop    %ebx
 695:	5e                   	pop    %esi
 696:	5f                   	pop    %edi
 ...
 6a6:	72 ce                	jb     676 <free+0x26>
{
 ...
 6c7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 6ca:	a3 b0 0a 00 00       	mov    %eax,0xab0
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6e9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6ec:	8b 15 b0 0a 00 00    	mov    0xab0,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 756:	e8 f5 fe ff ff       	call   650 <free>
  return freep;
 75b:	8b 15 b0 0a 00 00    	mov    0xab0,%edx
 ...
 784:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 787:	89 15 b0 0a 00 00    	mov    %edx,0xab0
}
 ...
 799:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 7a0:	c7 05 b0 0a 00 00 b4 	movl   $0xab4,0xab0
 7a7:	0a 00 00 
 7aa:	c7 05 b4 0a 00 00 b4 	movl   $0xab4,0xab4
 7b1:	0a 00 00 
    base.s.size = 0;
 7b4:	b8 b4 0a 00 00       	mov    $0xab4,%eax
 7b9:	c7 05 b8 0a 00 00 00 	movl   $0x0,0xab8
 7c0:	00 00 00 
