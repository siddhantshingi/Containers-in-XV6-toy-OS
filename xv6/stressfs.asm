...
00000472 <sleepcustom>:
SYSCALL(sleepcustom)
 472:	b8 1e 00 00 00       	mov    $0x1e,%eax
 477:	cd 40                	int    $0x40
 479:	c3                   	ret    

0000047a <wakeupcustom>:
